...
import { getAmazonCredentials, testAmazonConnection } from '../../services/amazon';
          ...
          <div className="border-t pt-4">
            <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <dd className="text-sm text-gray-900">
                  {connectionStatus.marketplace || 'N/A'}
                </dd>
              </div>
              {connectionStatus.rateLimit && (
                <>
                  <div>
                    <dt className="text-sm font-medium text-gray-500">API Rate Limit</dt>
                    <dd className="text-sm text-gray-900">
                      {connectionStatus.rateLimit.remaining} / {connectionStatus.rateLimit.total}
                    </dd>
                  </div>
                  <div>
